...
name28 = "Relation.Nullary.Reflects.fromEquivalence"
d28 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  Bool ->
...
d28 v0 v1 v2 v3 v4 = du28 v2 v3
du28 ::
  Bool -> (AgdaAny -> AgdaAny) -> MAlonzo.Code.Relation.Nullary.T14
du28 v0 v1
  = if coe v0
      then coe
...
name42 = "Relation.Nullary.Reflects.det"
d42 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  () ->
  Bool ->
